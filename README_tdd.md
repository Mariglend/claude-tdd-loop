...
```bash
git clone https://github.com/YOUR_USERNAME/claude-tdd-loop.git
cd claude-tdd-loop
pip install pytest
```
...
- [claude-warmup](https://github.com/YOUR_USERNAME/claude-warmup) — run warmup first if you're implementing inside an existing codebase
- [claude-swarm](https://github.com/YOUR_USERNAME/claude-swarm) — use swarm to write N test files in parallel, then tdd-loop to implement each
- [claude-resume](https://github.com/YOUR_USERNAME/claude-resume) — auto-resume if rate limit hits mid-loop
